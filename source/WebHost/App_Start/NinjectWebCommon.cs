...
namespace WebHost.App_Start
{
    ...
    public static class NinjectWebCommon 
    {
        ...
        private static IKernel CreateKernel()
        {
            ...
            // allows Web API calls to utilize Ninject.
            GlobalConfiguration.Configuration.DependencyResolver = new IoC.WebApiDependencyResolver(kernel);
        ...
        {
            kernel.Load(new DataModel.SQLite.SQLiteDataModelModule());
        }        
    }
}
